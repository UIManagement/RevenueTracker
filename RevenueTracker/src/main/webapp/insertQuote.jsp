...
<script>
$(function() {
	$("#insertquote\\:quotedate").datepicker({
		showOn : "button",
			...
			<table class=”tbl” cellpadding=”0″ cellspacing=”0″ border=”0″         >
				...
				<tr>
					...
					<td><h:message id="bRMessage" for="bR" />
						<h:inputText id="bR1" value="#{quote.bR}"
							 /></td>
				</tr>
				<tr>
					...
					<td><h:message id="customerIDMessage" for="customer_Name" />
						<h:inputText id="customer_Name" value="#{quote.customer_Name}"
							 /></td>
				</tr>
				...
				<tr>
					...
					<td><h:message id="CustomerTypeMessage" for="customer_Type" />
						<h:inputText id="customer_Type" value="#{quote.customer_Type}"
							 rendered="#{quote.customer_Type == 'seven'}" />
						<h:selectOneMenu value="#{quote.customer_Type}">
				...
				<tr>
					...
					<td><h:message id="CustomerAddressMessage" for="region" /> <h:inputText
							id="region" value="#{quote.region}" 
							rendered="#{quote.region == 'seven'}" /> <h:selectOneMenu
							value="#{quote.region}">
				...
				<tr>
					...
					<td><h:message id="CustomerserviceMessage" for="service" /> <h:inputText
							id="service1" value="#{quote.service}" 
							rendered="#{quote.service == 'seven'}" /> <h:selectOneMenu
							value="#{quote.service}">
				...
				<tr>
					...
					<td><h:message id="CustomerproductMessage" for="produc" /> <h:inputText
							id="product1" value="#{quote.product}" 
							rendered="#{quote.product == 'seven'}" /> <h:selectOneMenu
							value="#{quote.product}">
				...
				<tr>
					...
					<td><h:message id="CustomerdesignationMessage"
							...
							rendered="#{quote.designation == 'seven'}" /> <h:selectOneMenu
							value="#{quote.designation}">
				...
				<tr>
					<td><b> <h:outputLabel value="Quote Booked By::"
								for="quote_Booked_By" /> </b></td>
					<td><h:message id="quote_Booked_ByMessage"
							for="quote_Booked_By" /> <h:inputText id="quote_Booked_By"
							value="#{quote.quote_Booked_By}" 
							rendered="#{quote.quote_Booked_By == 'seven'}" /> <h:selectOneMenu
							value="#{quote.quote_Booked_By}">
...
<tr>
					...
					<td><h:message id="CustomercurrencyMessage" for="currency" />
						<h:inputText id="currency" value="#{quote.currency}"
							 rendered="#{quote.currency == 'seven'}" />
							  <h:selectOneMenu
				...
				<tr>
					...
					<td><h:message id="exchange_RateMessage" for="exchange_Rate" />
						<h:inputText id="exchange_Rate" value="#{quote.exchange_Rate}"
							 />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><h:message id="starting_monthMessage" for="starting_month" />
						<h:inputText id="starting_month" value="#{quote.starting_month}"
							 rendered="#{quote.starting_month == 'seven'}" />
							  <h:selectOneMenu
							value="#{quote.starting_month}">
				...
				<tr>
					<td><b> <h:outputLabel value="Quote Date  ::"
								for="quote_Date" /> </b></td>
					<td><h:message id="quote_DateMessage"
							for="quote_Date" /> <h:inputText id="quotedate"
							value="#{quote.quote_Date}" readonly="true"  />
					</td>
				</tr>
				<tr>
					<td><b> <h:outputLabel value="Quoted Mandays::"
								for="quoted_Mandays" /> </b></td>
					<td><h:message id="quoted_MandaysMessage"
							for="quoted_Mandays" /> <h:inputText id="quoted_Mandays"
							value="#{quote.quoted_Mandays}"  />
					</td>
				</tr>
				...
				<tr>
					<td><b> <h:outputLabel value="Quote Value ::"
								for="quote_Value" /> </b></td>
					<td><h:message id="quote_ValueMessage" for="quote_Value" /> <h:inputText
 							id="quote_Value" value="#{quote.quote_Value}"  /> 
					</td>
				</tr>

<tr>
					<td><b> <h:outputLabel value="Updated Quote Value::"
								for="updated_Quote_Value" /> </b></td>
					<td><h:message id="mandayvalue1Message" for="updated_Quote_Value" /> <h:inputText
							id="updated_Quote_Value" value="#{quote.updated_Quote_Value}" readonly="true"  />
					</td>
				</tr>


			</table>
			<h:commandButton action="#{quote.addAction}" value="Update" />&nbsp;&nbsp;

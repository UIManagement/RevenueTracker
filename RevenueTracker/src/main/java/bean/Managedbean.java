...
public class Managedbean   {
	...
	public String order_Booked_By;
	public String work_Order_Date;
	public String currency;
	public double work_Order_Value;
	public double exchange_Rate=1.00;
	public double updated_Work_Order;
	public String start_month;
	public String shared_Revenue;
	public double work_Order_Assessment_fee;
	public double work_Order_Logo_fee ;
	public double updated_WO_Assessment_fee;
	public String work_Order_Mandays;
	public double delivered_Mandays;
	...
	public double assessment_Fees;
	public double service_Tax;
	public double total_Invoice_Amount;
	public double logo_Fee_Database;
	public double sum_up;
	public double sum_dm;
	public double sum_pm;
	public double sum_pr;
	public int pm;
	public double dm;
	public double dm1;
	public String sm;
	public String sum_Del;
	public String invoice_Date;
	public double t_L;
	public int bR;
	public double period_rev;
	
	public double mandayvalue;
	public double sample_ID;
	public String auditor_Name;
	public String foreign;
	public String masterid;
	public String period_Mandays;
	public String date_ID;
	public String searchName;
	public String searchName1;
	public String searchName2;
	public String searchName3;
	public String  searchName4;
